#!/usr/bin/env python3
"""
Incremental Knowledge Graph Extraction V14.3.7

🎯 PURPOSE: Chapter-by-chapter extraction with type compatibility validation and title rehydration.
...
from src.knowledge_graph.postprocessing.pipelines.book_pipeline import get_book_pipeline_v1437
...
def extract_section(args: argparse.Namespace):
    ...
    # V14.3.7: Use dedicated get_book_pipeline_v1437() with new modules
    logger.info(f"🔧 Using V14.3.7 pipeline with TypeCompatibilityValidator + SubtitleJoiner")
    pipeline = get_book_pipeline_v1437()
    ...
    # Log V14.3.7-specific module stats
    ...
    manifest['pipeline_version'] = 'v14_3_7'
...
def main():
    parser = argparse.ArgumentParser(
        description="Incremental Knowledge Graph Extraction V14.3.7",
...
Examples:
  ...
  python3 scripts/extract_kg_v14_3_7_incremental.py \\
    ...
    parser.add_argument('--version', default='v14_3_7', help='Extraction version (default: v14_3_7)')
