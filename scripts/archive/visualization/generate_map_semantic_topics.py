"""
Generate podcast map with semantically meaningful topic labels
Uses K-means clustering + GPT-4 for label generation
"""
...
def build_map_data(vectors, embeddings_2d, cluster_labels, topic_labels):
    ...
    for idx, vector in enumerate(vectors):
        ...
        point = {
            ...
            "timestamp": timestamp,
            "cluster": cluster_id,  # For frontend compatibility
            "cluster_name": topic_info["label"],  # Semantic label instead of arbitrary name
            "topic": cluster_id,
    ...
    export_data = {
        ...
        "clusters": topics_list,  # Use "clusters" for frontend compatibility
        "topics": topics_list,  # Also include as "topics" for clarity
        "total_points": len(points),
        "total_topics": len(topics_list),
        "generated_with": "K-means + GPT-4"
    }
