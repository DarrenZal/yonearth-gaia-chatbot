...
class YonEarthRAGChain:
    ...
    def query(
        ...
        try:
            ...
            if settings.enable_graph_retrieval and self.graph_retriever and graph_mode != "off":
                try:
                    ...
                    # Merge graph chunks with hybrid results using RRF only in full mode;
                    # in evidence_only mode we keep hybrid retrieval intact and use graph
                    # solely for evidence.
                    if graph_mode == "full":
